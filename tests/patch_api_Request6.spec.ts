...
// For updating the booking token is required.
...
{
    // reading the file and returning the data in the file
...
test('update Booking(PUT)',async({request})=>
{
    ...
    const createrequestbody=readJson("testdata/requestbody.json");
